...
import Logo3d from "@/public/image/logo_3d.png";
import Logo1 from "@/public/image/logo_1.png";
  ...
  return (
    <section className="banner bg-img">
          ...
          <div className="col-12 col-sm-8 col-md-7 col-lg-7 col-xxl-6">
            <div className="banner__content text-center">
              <h1 className="title-animation">
                 Bringing the world’s<span>financial</span> ecosystem{" "}
      ...
      <div className="banner-thumb-one">
        <Image src={Logo3d} alt="Image" priority />
      </div>
      <Link className="scroll-position-btn" href="#scrollPosition">
        <Image src={Logo1} alt="Image" priority />
      </Link>
    </section>
  );
};
