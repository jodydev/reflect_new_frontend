      ...
      <div className="flex flex-wrap justify-center items-center space-x-0 md:space-x-10 2xl:space-x-20 space-y-10 md:space-y-0">
        {cardData.map((data, index) => {
          ...
          return (
              ...
              >
                <div
                  className={`${isHovered ? " bg-dark text-white md:w-[400px] 2xl:w-[700px]" : "bg-gray-100 bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-40 saturate-100 backdrop-contrast-100" }  relative flex flex-col items-center justify-start px-10 py-16 w-[320px] h-[340px] md:w-[300px] md:h-[350px] 2xl:w-[500px] 2xl:h-[500px] transition-all duration-500 ease-in-out transform hover:cursor-pointer`}
