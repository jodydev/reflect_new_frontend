...
>
  ...
  <div className="flex flex-col md:grid md:grid-cols-2 justify-center items-start space-y-8 md:space-y-0 sm:-space-x-20 -space-x-40">
        ...
        {cardData.map((item, index) => {
          ...
          return (
            <div
              ...
              className={`absolute right-[-60px] sm:right-[-200px] md:right-[-75px] mm:right-[-100px] lg:right-[100px] fh:right-[100px] 2xl:right-[150px] top-32 sm:top-40 md:top-40 2xl:top-80 flex items-center justify-center text-white text-center ${
                isSelected
                  ? "w-72 h-60"
    ...
    <div className="hidden lg:block relative z-10 py-12 md:py-24 2xl:py-56 px-4 md:px-20 lg:px-60 fh:px-72 2xl:px-96">
    ...
    <div className="block lg:hidden absolute bottom-40 right-0 left-[45%]">
